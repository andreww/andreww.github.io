...
placemarks = docRoot.xpath("##-XPATH-1-##", namespaces)
# print placemarks

for node in placemarks:
    event_id = node.xpath("##-XPATH-2-##", namespaces)[0]
#    print "This event has id:" + event_id

    initial_latitude = node.xpath("##-XPATH-3-##", namespaces)[0]
#    print "This event's initial latitude is:" + initial_latitude
 
    initial_longitude = node.xpath("##-XPATH-4-##", namespaces)[0]
#    print "This event's initial longitude is:" + initial_longitude

    final_latitude = node.xpath("##-XPATH-5-##" 
      + event_id + "##-More-XPATH-5-##", namespaces)[0]
#    print "This event's final latitude is " + final_latitude 

    final_longitude = node.xpath("##-XPATH-6-##" 
      + event_id + "##-more-XPATH-6-##", namespaces)[0]
